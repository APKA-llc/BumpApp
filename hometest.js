    ...
    <View style={styles.parentcontainer}>
        ...
        <View style={styles.bottomHalf}>
            ...
            <View style={styles.two}>
                <Text style={styles.description}>19, Sophomore Currently Studying Med</Text>
                <Text style={styles.bio}>   </Text>
                <Text style={styles.bio}>I like art, pizza, and animals. I'm looking forward to making friends I can nerd out and relax with. If you get me started on cookout lore i will talk to you for hours and hours.</Text> 
            </View>
